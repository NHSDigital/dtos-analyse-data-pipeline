module "azure_sql_server" {
  ...
  # Default database
  db_name_suffix = var.sqlserver.dbs.adp.db_name_suffix
  collation      = var.sqlserver.dbs.adp.collation
  licence_type   = var.sqlserver.dbs.adp.licence_type
  max_gb         = var.sqlserver.dbs.adp.max_gb
  read_scale     = var.sqlserver.dbs.adp.read_scale
  sku            = var.sqlserver.dbs.adp.sku
